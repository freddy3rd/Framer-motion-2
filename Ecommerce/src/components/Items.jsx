...
return (
  ...
  className='w-full h-screen grid grid-cols-1 md:grid-cols-[250px_1fr] gap-5 items-center justify-center sm:px-10 px-2'>
    <div className='margin-auto  p-5 shadow-lg rounded-2xl max-w-[200px] md:mx-2 mx-10 sticky top-0'>
    ...
    {Items_data.map((data) =>{
       ...
       return(
        ...
        className='text-center' key={data.id}>
          ...
          <th>
            <button className="btn btn-ghost btn-xs px-4 font-bold">View Detail</button>
          </th>
